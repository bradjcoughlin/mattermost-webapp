...
export function applyTheme(theme) {
    ...
    if (theme.buttonColor) {
        ...
        changeCss('.app__body .file-view--single .file__download svg', 'stroke:' + theme.buttonColor);
    }
